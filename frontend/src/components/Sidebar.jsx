...
const Sidebar = ({ onSelectLesson, selectedLessonId }) => {
  ...
  return (
    <div className="w-80 bg-card border-r border-border h-full flex flex-col animate-fade-in overflow-hidden">
      <div className="p-6 border-b border-border bg-gradient-to-r from-primary/5 to-primary/10 flex-shrink-0">
        ...
        <p className="text-sm text-muted-foreground mt-1">Interactive CUDA Learning Platform</p>
      </div>
            ...
            >
              ...
              >
                <div className="flex items-start gap-3 w-full min-w-0">
                  <div className="transition-transform duration-200 flex-shrink-0 mt-0.5">
                  ...
                  <div className="flex-1 min-w-0 space-y-2">
                    ...
                    {!module.locked && (
                      <div className="flex items-center gap-3 w-full">
                        ...
                        <span className="text-xs font-medium text-primary flex-shrink-0 min-w-[32px]">{module.progress}%</span>
                      </div>
                    )}
                  </div>
                </div>
